    ...
    for subdir, dirs, files in os.walk(input_dir):
        for f in files:
            ...
            try:
                ...
                img_arr = np.pad(img_arr, ((0, MAX_LEN - shape[0]), (0, MAX_WIDTH - shape[1])), 'constant')
            img_lst.append(img_arr)
            label_lst.append(label)
...
np.save("DATA/padding_train_label_aug",train_labels_pad)
#np.save("DATA/padding_test_label_aug",test_labels_pad)
